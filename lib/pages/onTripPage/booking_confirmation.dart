...
//get location permission and location details
  ...
  children: [
    InkWell(
      ...
      child: Container(
        ...
        alignment: Alignment.center,
        child: Icon(
          Icons.share, // Replace with the share icon
          color:  buttonColor,
                                                                                                          ...
                                                                                                          child: (rentalOption[i]['has_discount'] != true)
                                                                                                              ...
                                                                                                              : Row(
                                                                                                                  ...
                                                                                                                  children: [
                                                                                                                    ...
                                                                                                                    Text(
                                                                                                                      rentalOption[i]['fare_amount'].toStringAsFixed(0),
                                                                                                                      style: GoogleFonts.roboto(fontSize: media.width * fourteen, color: textColor, fontWeight: FontWeight.w600, decoration: TextDecoration.lineThrough),
                                                                                                                    ),
                                                                                                                    Text(
                                                                                                                      ' ${rentalOption[i]['discounted_totel'].toStringAsFixed(0)}',
                                                                                                                      style: GoogleFonts.roboto(fontSize: media.width * fourteen, color: textColor, fontWeight: FontWeight.w600),
                                                                                                                    )
                                                                                                                  ],
                                                                                                                ))
 ...
 child: Container(
  height: media.width * 0.12, // Adjusted height
  width: media.width * 0.15, // Adjusted width
  decoration: BoxDecoration(
    borderRadius: BorderRadius.circular(media.width * 0.16),
    color: buttonColor,
  ),
  alignment: Alignment.center,
  child: Image.asset(
    'assets/images/later.png', // Replace with the path to your icon asset
    fit: BoxFit.contain,
  ),
),
                                                                            ...
                                                                            : (promoStatus == 2)
                                                                                ? Container(
                                                                                    ...
                                                                                    child: Row(
                                                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                                      children: [
                                                                                        Text(promoKey.text, style: GoogleFonts.roboto(fontSize: media.width * twelve, color: const Color(0xff203b6b))),
                                                                                        InkWell(
                                                                                          onTap: () async {
                                                                                            setState(() {
                                                                                              _isLoading = true;
                                                                                          ...
                                                                                          child: Text(languages[choosenLanguage]['text_remove'], style: GoogleFonts.roboto(fontSize: media.width * twelve, color: const Color(0xff203b6b))),
                                                                                        )
                                                                                      ],
                                                                                    ),
                                                                                  )
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        (chatList.where((element) => element['from_type'] == 2 && element['seen'] == 0).isEmpty)
                                                                            ...
                                                                            : Text(
                                                                                ...
                                                                                style: GoogleFonts.roboto(fontSize: media.width * twelve, color: const Color(0xff203b6b)),
                                                                              )
                                                                      ],
                                                                    ),
                                                                  ),
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              ...
                                                                              width: media.width * 0.025,
                                                                              alignment: Alignment.center,
                                                                              decoration: BoxDecoration(shape: BoxShape.circle, color: const Color(0xff203b6b).withOpacity(0.3)),
                                                                              child: Container(
                                                                                height: media.width * 0.01,
                                                                                width: media.width * 0.01,
                                                                                decoration: const BoxDecoration(shape: BoxShape.circle, color: Color(0xff203b6b)),
                                                                              ),
                                                                            ),
                                                                          ],
                                                                        ),
