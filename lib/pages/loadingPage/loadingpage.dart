...
class _LoadingPageState extends State<LoadingPage> {
  ...
  //get language json and data saved in local (bearer token, chosen language) and find the user's current status
            ...
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/earth_video.gif'),
                  fit: BoxFit.cover,
                ),
              ),
              child: Column(
